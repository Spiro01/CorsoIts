...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\User\Desktop\CorsoIts\BigData\jupyter'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\User\Desktop\CorsoIts\BigData\jupyter\Scripts\deactivate.nu'
